    ...
    <div className="app">
      ...
      <div className="about-card animated-fade-in">
        ...
        <p className="about-paragraph">
          I’m a <strong>2nd-year Mechanical Engineering student</strong> at XYZ University. I’m a tech enthusiast with a passion for <em>web development</em> — creating interactive and user-friendly websites.
        </p>
        <p className="about-paragraph">
